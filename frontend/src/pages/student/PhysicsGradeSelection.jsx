...
import { GRADES } from '../../data/physicsExperiments';

export default function PhysicsGradeSelection() {
  ...
  const gradeDetails = {
    'Grade 10': {
      topics: 'Measurement, Mechanics, Moments, Energy, Machines',
      image: '/assets/experiment_placeholder.jpg',
      color: 'from-blue-500 to-indigo-600',
      description: 'Foundational physics principles and laboratory techniques.'
    },
    'Grade 11': {
      topics: 'Thermal Physics, Waves, Sound, Light, Magnetism',
      image: '/assets/experiment_placeholder.jpg',
      color: 'from-emerald-500 to-teal-600',
      description: 'Exploring vibrations, thermodynamics and the nature of light.'
    },
    'Grade 12': {
      topics: 'Static Electricity, Current Electricity, Induction, Transformers',
      image: '/assets/experiment_placeholder.jpg',
      color: 'from-orange-500 to-red-600',
      description: 'Advanced electromagnetism and electrical systems.'
    }
  };
    ...
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-3xl font-black text-gray-900 italic tracking-tight underline decoration-primary-vibrant/20 underline-offset-8">Physics Virtual Lab</h1>
      ...
      {availableGrades.length > 0 ? (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {availableGrades.map((grade) => (
            <div 
              key={grade}
              onClick={() => navigate(`/student/lab/physics/${grade.replace(' ', '')}`)}
        ...
        <div className="py-20 bg-white rounded-[2rem] border border-gray-100 border-dashed flex flex-col items-center justify-center text-center p-10 max-w-2xl mx-auto shadow-sm">
           ...
           <p className="text-gray-500 mt-4 leading-relaxed font-medium">
             You are currently registered in <span className="font-black text-slate-900">{studentGrade}</span>. The Physics curriculum module you've accessed is exclusively for Secondary School Grades 10, 11, and 12.
           </p>
           <button 
             onClick={() => navigate('/student/lab')}
