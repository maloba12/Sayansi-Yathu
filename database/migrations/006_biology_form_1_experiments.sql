-- Insert Form 1 Biology Experiments
INSERT INTO experiments (title, subject, description, difficulty_level, simulation_type, curriculum, grade_or_form) VALUES
('Scientific Inquiry Method', 'biology', 'To apply the scientific inquiry method in carrying out scientific investigations.', 'beginner', 'sci_method', 'new', 'Form 1'),
...
('Basic Cell Structure', 'biology', 'To explore the basic cell structure.', 'beginner', 'cell', 'new', 'Form 1'),
...
('Reproduction in Living Organisms', 'biology', 'To demonstrate understanding of how living organisms reproduce.', 'intermediate', 'dna', 'new', 'Form 1'),
